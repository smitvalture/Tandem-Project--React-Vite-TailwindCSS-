                        ...
                        <div id="menu" className={`hidden lap:block`}>
                            ...
                            <div className="lap:flex lap:items-center mt-10 lap:bottom-5 space-x-4 lap:absolute lap:right-5">
                                <a onClick={() => setToggle(!toggle)} href="/sign_up.html" target="_blank" rel="noopener noreferrer">
                                    <button className="w-28 h-9 font-medium text-white lap:text-black bg-[#1F3C88] lap:bg-transparent hover:bg-[#23459a] lap:hover:bg-transparent lap:hover:text-cyan-500 border border-1 border-[#1F3C88] hover:border-cyan-500 lap:border-0 rounded-full" name="login" type="submit">
                                        Get started
                                    </button>
                                </a>
